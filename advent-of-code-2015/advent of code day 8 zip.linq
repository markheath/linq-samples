...
new[] { "sjdivfriyaaqa\xd2v\"k\"mpcu\"yyu\"en",
"vcqc",
...
"ccxjgiocmuhf\"ycnh",
"lltj\"kbbxi" }
.Zip(File.ReadAllLines(Path.GetDirectoryName(Util.CurrentQueryPath) + "\\day8.txt"),
(a, b) => new { a, b , 
		c = Regex.Replace(b.Substring(1, b.Length - 2)
		.Replace("\\\"", "\"")
        .Replace("\\\\", "?"),
        @"\\x[0-9a-f][0-9a-f]", "?")
    })
.Where(x => x.a.Length != x.c.Length)
//.Select(x => x.b.Length - x.a.Length)
//.Sum()

// fails because "\x04b" = "K"
